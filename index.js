...
const connection = mysql.createConnection({
    host: "owianacrafts.my.id",
    user: "owianacr_user",
    password: "M@k@nM1e1n5t4n",
    database: "owianacr_craft"
});
    ...
    connection.query(getProductQuery, [productId], (err, productResults) => {
        ...
        connection.query(getUserQuery, [userId], (err, userResults) => {
            ...
            const insertOrderQuery = `
                INSERT INTO orders 
                (kategori_produk, nama_produk, qty, total_harga, buyer_fullname, buyer_email, buyer_address) 
                VALUES (?, ?, ?, ?, ?, ?, ?)
            `;
            ...
            const orderValues = [
                ...
                buyer_fullname,
                buyer_email,
                buyer_address, // Replace with actual buyer note
            ];
            ...
            connection.query(insertOrderQuery, orderValues, (err, insertResult) => {
                ...
                res.render('notifikasipesanan', {data:orderValues})
            });
        });
    });
});
